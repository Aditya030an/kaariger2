...
const originals = [
  ...
  },
  {
    ...
    width: 25,
    description:
      "“The Final Lap” captures the raw intensity and thrill of an F1 car in its ultimate sprint toward victory. With dynamic motion and streaks of colour, the painting freezes a heartbeat of speed, focus, and adrenaline. It embodies the spirit of competition — where precision meets passion in the race against time.",
  },

  {
    ...
    width: 20,
    description:
      "“The Quiet Coast” beautifully captures the serene moment where gentle waves kiss the golden sand. Soft hues and fluid textures evoke a sense of calm and solitude, as if time itself slows at the shore. The painting invites reflection — a quiet dialogue between water, earth, and peace.",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    width: 25,
    description:
      "“Metre Down” captures the pulse of urban India through vibrant, abstract lines that mirror the rhythm of city streets. At its heart, an Indian auto rickshaw speeds ahead — bold, lively, and full of character. The painting celebrates motion, colour, and the everyday chaos that fuels life on the go.",
  },
  {
    id: 7,
    title: " Beyond Miles ",
    ...
    width: 25,
    description:
      "“Beyond Miles” evokes the quiet freedom of a journey unfolding on open roads. Painted in soft watercolour tones, it captures the rear view of a rider lost in motion — where distance fades and dreams take the lead. The artwork celebrates wanderlust, solitude, and the poetry of endless horizons.",
  },
  {
    id: 8,
    title: " Into The Pour ",
  ...
  },
  {
    ...
    width: 30,
    description:
      "“The Last Bet” captures the tension of a final poker hand — a dimly lit table scattered with cards, cigars, wine glasses, and stacks of money. The smoky atmosphere  evoke suspense, temptation, and the thrill of risk. Every detail reflects the quiet chaos before fate is sealed — one final move, one last gamble.",
  },
  {
    id: 13,
    title: "A Deep Breath ",
...

  {
    ...
    width: 20,
    description:
      "“The Monochrome Lady” portrays a beautiful woman bathed in shades of black and white, where light and shadow dance across her features. The absence of color heightens her grace, emotion, and timeless elegance. Every contour and gaze speaks in silence — a poetic blend of mystery and sophistication.",
  },
  {
    id: 17,
...

  {
    ...
    width: 20,
    description:
      "“The Evening Sip” is a hyper-realistic sketch capturing the quiet luxury of unwinding. Whiskey glasses glisten with melting ice cubes, their textures rendered in exquisite detail. The monochrome tones highlight light and reflection, evoking warmth, sophistication, and the calm ritual of a perfect evening.",
  },
  {
    id: 23,
    title: "Noir Elan ",
  ...
  // },
  {
    ...
    width: 25,
    description:
      "A powerful sketch of a crushed Ace of Spades — symbolizing both victory and defeat in a single frame. The rough lines and broken edges reflect the fragile balance between luck and fate, where even the strongest card can fall under pressure.",
  },
  ...
  },
  {
    ...
    width: 25,
    description:
      "A bold reinterpretation of the King of Hearts, blending geometric precision with royal elegance. The rich red and gold tones symbolize passion and power united in harmony. Modern minimalism meets timeless royalty — the heart of the deck reborn.",
  },

  {
    ...
    width: 25,
    description:
      "A sleek blue Cadillac rests under the glow of city lights, its chrome gleaming against the night sky. The deep indigo tones evoke mystery, freedom, and untold stories of the road. Every curve of the car whispers nostalgia — a tribute to timeless elegance and midnight drives.",
  },
  {
    id: 30,
    ...
    width: 20,
    description:
      "This monochrome painting captures the quiet soul of an old Indian street at dawn. The soft mist and diffused light blend into the aged architecture, where silhouettes of people begin their daily chores. The sweeping figure in the foreground symbolizes simplicity and rhythm in everyday life — a gentle harmony between man, light, and the timeless city.",
  },
  {
    id: 31,
  ...
  },
  {
    ...
    width: 18,
    description:
      "A moody monochrome cityscape captures the rhythm of urban life under a veil of rain. Cars move through glistening streets as towering buildings fade into mist, reflecting both chaos and calm. The scene beautifully blends motion and stillness, embodying the poetry hidden in everyday rush.",
  },
  {
    id: 40,
    ...
    width: 25,
    description:
      "A captivating play of chance and control — where countless cards lie face down, yet one reigns above them all. The Queen of Hearts emerges boldly, symbolizing confidence, power, and grace amidst chaos. This artwork reminds us that true strength stands out, even when surrounded by uncertainty.",
  },
  {
    id: 41,
    title: "Mrs. Bijou ",
...

  {
    ...
    width: 18,
    description:
      "A lone rider speeds through a rain-kissed mountain road, chasing freedom between sky and earth. The sunlight pierces through drifting clouds, illuminating the winding path ahead. Every droplet, every turn, captures the essence of motion and peace — the pure joy of riding at the edge of nature’s beauty.",
  },
  {
    id: 44,
    title: "Vroom Town ",
    ...
    width: 20,
    description:
      "A thrilling depiction of vintage race cars hurtling through a vibrant track, capturing the essence of speed and competition. The bold colors and dynamic lines create a sense of motion and adrenaline. The artwork celebrates the golden age of racing — where precision, passion, and velocity ruled the road.",
  },
  {
    id: 45,
